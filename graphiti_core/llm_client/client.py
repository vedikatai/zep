...
class LLMClient(ABC):
    ...
    async def generate_response(
        ...
        *,
        ...
        # Replay cache: serve deterministic responses without calling the real LLM.
        # Checked before mutating messages so keys stay stable across replay runs.
        from graphiti_core.utils.replay import check_replay_llm_cache

        cached_replay = check_replay_llm_cache(messages, prompt_name)
